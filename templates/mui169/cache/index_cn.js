...
METUI_FUN['product_list_met_36_1']={
	...
	init:function(){
     $(".product_list_met_36_1 .carousel").carousel({
     	interval: 10000
     });
     $(".product_list_met_36_1 .carousel-control-next").click(function(){
     $(".product_list_met_36_1 .carousel").carousel('next');
      });
     $(".product_list_met_36_1 .carousel-control-prev").click(function(){
      	$(".product_list_met_36_1 .carousel").carousel('prev');
     });
     //样式循环
...
METUI_FUN['news_list_met_36_2']={
    name:'news_list_met_36_2',
    init:function(){
      //点击右侧列表
      var news_panel=METUI['news_list_met_36_2'].find('.header_news_panel'),
          list=news_panel.find(".nav-tabs li a");
          list.on('click',function(){
            list.removeClass('active');
            $(this).addClass('active');
            METUI['news_list_met_36_2'].find('.tab-pane.fade').removeClass('in active');
            var left_list = METUI['news_list_met_36_2'].find('.tab-pane.fade');
...
var x=new metui(METUI_FUN['news_list_met_36_2']);
