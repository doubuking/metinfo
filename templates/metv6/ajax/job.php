...
<div class="card card-shadow">
	...
	<div class="card-body-footer m-t-0">
		<a class="btn btn-outline btn-squared btn-primary met-job-cvbtn" href="javascript:;" data-toggle="modal" data-target="#met-job-cv" data-jobid="{$v.id}" data-cvurl="cv.php?lang=cn&selected">{$lang.cvtitle}</a>
	</div>
</div>
</tag>