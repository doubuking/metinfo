...
str;
    ...
    public function _option( $attr, $content ) {
        ...
        $php    = <<<str
    <?php
    \$search = load::app_class('shop/include/class/shop_search','new')->getSpeclist($type, \$data['classnow'], \$data['page']);
    ?>
str;

        /*$spec_list = load::app_class('shop/include/class/shop_search','new')->getSpeclist();
        dump($spec_list);*/
