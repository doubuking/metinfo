...
<?php } ?>
            ...
            <div class="login_link m-t-10 ">
                ...
                if($_M['enterprisel']){
                ?>
                    <a class="text-xs-left" href="<?php echo $_M['url']['register'];?>"><?php echo $_M['word']['generaluserregistration'];?></a>
                <?php }else{ ?>
                    <a class="text-xs-left" href="<?php echo $_M['url']['enterprisel_register'];?>"><?php echo $_M['word']['enterpriseuserregistration'];?></a>
                <?php  } ?>
                <a style="float: right" href="<?php echo $_M['url']['login'];?>"><?php echo $_M['word']['acchave'];?></a>
            </div>
		</form>
	</div>
</div>
