...
include_once "USERConfig_{$_M['lang']}.php";
...
class SDKConfig {
	...
	function __construct(){
		...
		#$configFilePath = dirname(__FILE__) . "/acp_sdk.ini";       //生产环境配置
        if(UNIPAY_TEST == '0'){
            $configFilePath = dirname(__FILE__) . "/acp_sdk_prod.ini";
        }else{
        ...
        $this->signCertPath = SDK_SIGN_CERT_PATH;
        /*if(UNIPAY_TEST == 1){
            //测试接口私钥
            $this->signCertPath = __DIR__.'/certs/acp_test_sign.pfx';
        }*/
        ...
        $this->encryptCertPath  = __DIR__.'/certs/acp_prod_enc.cer';
        $this->rootCertPath     = __DIR__.'/certs/acp_prod_root.cer';
		$this->middleCertPath   =  __DIR__.'/certs/acp_prod_middle.cer';
