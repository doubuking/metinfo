...
<div class="register-index met-member page p-y-50 bg-pagebg1">
	<div class="container">
	<form class="form-register ui-from met-form-validation p-30 bg-white" method="post" action="<?php echo $_M['url']['password_valid'];?>">
		...
		<div class="form-group">
			<div class="input-group">
				...
				<input type="password" name="password" class="form-control" placeholder="<?php echo $_M['word']['newpassword'];?>" required
		...
		<div class="form-group">
			<div class="input-group">
				<span class="input-group-addon"><i class="fa fa-unlock-alt"></i></span>
				<input type="password" name="confirmpassword" data-password="password" class="form-control" placeholder="<?php echo $_M['word']['renewpassword'];?>" required
				data-fv-notempty-message="<?php echo $_M['word']['noempty'];?>"
				data-fv-identical="true"
