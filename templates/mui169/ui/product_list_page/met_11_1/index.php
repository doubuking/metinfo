    ...
    <!--展示内容-->
            ...
            <!--标准-->
                                    <li class='p-r-15  item' >
                                        <div class="card ">
                                            <figure class="overlay overlay-hover">
                                            <img class="overlay-figure" src="{$v.imgurl|thumb:$c['met_productimg_x'],$c['met_productimg_y']}" alt="{$v.title}">
                                            <a href="{$v.url}" {$g.urlnew} class="overlay-panel overlay-background overlay-fade overlay-icon">
                                              <i class="fa fa-search"></i>
                                            </a>
                                            </figure>
                                            <h4 class="card-title p-y-20 font-szie-16 ">
                                                <a href="{$v.url}" title="{$v.title}" class="block text-truncate" {$g.urlnew}>{$v.title}</a>
                                                <p class="keyword">{$v.keywords}</p>
        ...
        <!--橱窗-->
                                    ...
                                    <div class="card ">
                                        ...
                                        <p class="price m-b-0 m-t-5">{$v.price_str}</p>
                                        <a href="{$v.url}" title="{$v.title}" class="btn btn-default" {$g.urlnew}>{$word.Detail}</a>
                                        </h4>
                                    </div>
                                    </li>
        <!--橱窗-->
