...
<link href="{$_M['url']['site']}public/ui/v2/static/css/basic_admin.css?{$met_file_version}" rel='stylesheet' type='text/css'>
                ...
                <div class="btn-group" {$met_agents_metmsg}>
                    ...
                    <ul class="dropdown-menu animate animate-reverse dropdown-menu-right text-xs-center">
                        ...
                        <li class="dropdown-item">
                            <a href="https://www.metinfo.cn/web/product.htm" target="_blank" class='block'>{$_M['word']['sys_authorization2']}</a>
                        </li>
                        <li class="dropdown-item">
