            ...
            <div class="panel">
                <div class="panel-body row pay-order-top">
                    ...
                    <div class="col-lg-7 col-md-6">
                        <h1 class='text-xs-center text-md-left'><?php echo $word['pay_ordersuccess'];?></h1>
                            <?php if($data['order']['countdown']){ ?>
                        <p><?php echo $word['pay_please'];?> <span class="red-600"><?php echo $data['order']['countdown'];?></span> <?php echo $word['pay_pleasepayment'];?></p>
                        <?php } ?>
                        <p><?php echo $word['pay_ordernumber'];?> : <span class="m-r-20 red-600"><?php echo $data['order']['out_trade_no'];?></span>
                            <br class='hidden-sm-up'>
                            <?php echo $word['pay_subject'];?> : <span class="m-r-20 red-600"><?php echo $data['order']['subject'];?></span>
                            <br class='hidden-sm-up'>
                            <!--<a href="javascript:void(0)" class="grey-600 dropdown-toggle" data-toggle="collapse" data-target="#order-info"><?php echo $word['pay_orderdetails'];?>[订单详情]</a>-->
                        </p>
                        <!--<div class="collapse" id="order-info">
                            <div class="well m-b-0">
                                <div><?php echo $word['pay_receiving'];?>[收货信息] : <?php echo $data['order']['address_str'][''];?></div>
                                <div class="m-t-10 clearfix">
                                    <div class='pull-md-left m-r-5'><?php echo $word['pay_commodity'];?>[商品] :</div>
                                    <div class='pull-md-left'>

                                        <lista data="$data.goods_list" name="$good">
                                        <span class='m-r-10'><?php echo $good['pname'];?>-<?php echo $good['para'];?></span>
                                    ...
                                    <?php if($data['order']['invoice_info']){ ?>
                                <p class="m-b-0 m-t-10"><?php echo $word['pay_invoice'];?>[发票] : <?php echo $data['order']['invoice_info']['0'];?> <?php echo $data['order']['invoice_info']['1'];?> <?php echo $data['order']['invoice_info']['2'];?> <?php echo $data['order']['invoice_info']['3'];?></p>
                                <?php } ?>
                    ...
                    <div class="col-lg-3 col-md-4 text-md-right font-size-20 pay-order-price">
                        <?php echo $word['pay_paytotal'];?> :
                       <span class="red-600 font-size-24"><?php echo $data['order']['total_fee_str'];?></span>
                    </div>
                </div>
            </div>
            <div class="panel m-b-0">
                <div class="panel-body">
                        <?php if($data['payment_open']){ ?>
                        <h2 class="panel-title p-0"><?php echo $word['pay_paymod'];?></h2>
                    <?php }else{ ?>
                        <h2 class="panel-title p-0"><?php echo $word['pay_clse_tips'];?></h2>
                    <?php } ?>
                    <hr class='m-b-20'>
                    <ul class="blocks-xs-2 blocks-sm-3 blocks-md-4 blocks-lg-5 blocks-xl-6 pay-order-mode-body">
                            <?php if($data['pay_list']['alipay']){ ?>
                        <li class="text-xs-center pay-order-zhifubao" data-toggle="modal" data-target="#pay-order-modal">
                            <a class="block cover pay-online"  href="<?php echo $data['pay_list']['alipay']['url'];?>" " target="_blank">
                            <img src="<?php echo $_M[url][own_tem];?>img/payOnline_zfb.png" class='img-fluid inline-block'/></a>
                        </li>
                        <?php } ?>
                            <?php if($data['pay_list']['alipaywap']){ ?>
                            <li class="text-xs-center pay-order-zhifubao" data-toggle="modal" data-target="#pay-order-modal">
                                <a class="block cover pay-online"  href="<?php echo $data['pay_list']['alipaywap']['url'];?>" " target="_blank">
                                <img src="<?php echo $_M[url][own_tem];?>img/payOnline_zfb.png" class='img-fluid inline-block'/></a>
                            </li>
                        <?php } ?>
                            <?php if($data['pay_list']['tenpay']){ ?>
                        <li class="text-xs-center pay-order-zhifubao" data-toggle="modal" data-target="#pay-order-modal">
                             <a class="block cover pay-online"  href="<?php echo $data['pay_list']['tenpay']['url'];?>"  target="_blank"><img src="<?php echo $_M[url][own_tem];?>img/tenpay.png" class='img-fluid inline-block'/></a>
                        </li>
                        <?php } ?>
                            <?php if($data['pay_list']['weixin']){ ?>
                        <li class="text-xs-center pay-order-weixin">
                            <a class="block cover pay-online payment-weixin" href="<?php echo $data['pay_list']['weixin']['url'];?>" data-url="<?php echo $data['pay_list']['weixin']['url'];?>" target="_blank" data-check_url="<?php echo $data['pay_list']['weixin']['check_url'];?>">
                            <img src="<?php echo $_M[url][own_tem];?>img/weixinpay.png" class='img-fluid inline-block'/></a>
                        </li>
                        <!-- Modal -->
                            ...
                            <div class="modal-dialog modal-center modal-sm">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        ...
                                        <h4 class="modal-title"><?php echo $word['pay_scanpayment'];?></h4>
                                    </div>
                        ...
                        <?php } ?>
                            <?php if($data['pay_list']['weixin_h5']){ ?>
                        <li class="text-xs-center pay-order-weixin">
                            <a class="block cover pay-online payment-weixin-h5" href="<?php echo $data['pay_list']['weixin_h5']['url'];?>" data-url="<?php echo $data['pay_list']['weixin_h5']['url'];?>" data-check_url="<?php echo $data['pay_list']['weixin_h5']['check_url'];?>">
                            <img src="<?php echo $_M[url][own_tem];?>img/weixinpay.png" class='img-fluid inline-block'/></a>
                        </li>
                        <!-- End Modal -->
                        <!-- Modal -->
                        ...
                        <?php } ?>
                        <!--微信H5-->
                            <?php if($data['pay_list']['weixin_web_h5']){ ?>
                        <li class="text-xs-center pay-order-weixin-web-h5" data-toggle="modal" data-target="#pay-order-modal">
                            <a class="block cover pay-online payment-weixin-web-h5"  href="<?php echo $data['pay_list']['weixin_web_h5']['url'];?>" data-url="<?php echo $data['pay_list']['weixin_web_h5']['url'];?>" data-check_url="<?php echo $data['pay_list']['weixin_web_h5']['check_url'];?>" target="_blank">
                            <img src="<?php echo $_M[url][own_tem];?>img/weixinpayH5.png" class='img-fluid inline-block'/></a>
                        </li>
                        <?php } ?>
                        <!--银联b2c-->
                            <?php if($data['pay_list']['upay']){ ?>
                        <li class="text-xs-center pay-order-union" data-toggle="modal" data-target="#pay-order-modal">
                            <a class="block cover pay-online" href="<?php echo $data['pay_list']['upay']['url'];?>" target="_blank">
                            <img src="<?php echo $_M[url][own_tem];?>img/unionpay.png" class='img-fluid inline-block'/></a>
                        </li>
                        <?php } ?>
                        <!--银联b2b-->
                            <?php if($data['pay_list']['upayb2b']){ ?>
                        <li class="text-xs-center pay-order-unionb2b" data-toggle="modal" data-target="#pay-order-modal">
                            <a class="block cover pay-online" href="<?php echo $data['pay_list']['upayb2b']['url'];?>"  target="_blank">
                            <img src="<?php echo $_M[url][own_tem];?>img/unionpayb2b.png" class='img-fluid inline-block'/></a>
                        </li>
                        <?php } ?>
                        <!--paypal-->
                            <?php if($data['pay_list']['paypal']){ ?>
                        <li class="text-xs-center pay-order-union" data-toggle="modal" data-target="#pay-order-modal">
                            <a class="block cover pay-online" href="<?php echo $data['pay_list']['paypal']['url'];?>" data-url="<?php echo $data['pay_list']['paypal']['url'];?>" target="_blank">
                            <img src="<?php echo $_M[url][own_tem];?>img/paypal.png" class='img-fluid inline-block'/></a>
                        </li>
                        <?php } ?>
                    </ul>
                    <!--
                    ...
                    <!--余额支付ss-->
                        <?php if($data['payment_open']){ ?>
                            <?php if($data['order']['no']<>10080){ ?>
                                <?php if($data['balance']['user_have_balance']){ ?>
                                <a class="btn btn-lg btn-outline btn-default btn-squared m-b-10 pay-oder-balance" data-toggle="collapse" data-target="#balanceinput">
                                    <?php echo $word['pay_balancepay'];?>
                                    <span class="red-600">
                                        <?php echo $data['balance']['balance_str'];?>
                                    </span>
                                </a>
                                <br>
                                <div class="collapse" id="balanceinput">
                                    <div class="well m-b-0"">
                                        <form method="post" action="<?php echo $data['balance']['url'];?>" class="met-form-validation" id="pay-balance">
                                            <input name="id" type="hidden" value="<?php echo $order[id];?>">
                                            <div class="form-group">
                                                <input type="password" name="password" class="form-control" placeholder="<?php echo $word['memberPassword'];?>" required data-fv-notempty-message="<?php echo $word['memberPassword'];?>">
                                            </div>
                                            <div class="form-group m-b-0">
                                                <button type="submit" class="btn btn-primary"><?php echo $word['pay_ok'];?></button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
                            <?php }else{ ?>
                                <a href="<?php echo $_M['url']['recharge'];?>" target="_blank" class="btn btn-lg btn-outline btn-default btn-squared font-size-14 red-600"><?php echo $word['pay_recharge'];?></a>
                            <?php } ?>
                        <?php } ?>
                    <?php } ?>
                    <!--//余额支付-->
    ...
    <div class="modal-dialog modal-center modal-sm">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title"><?php echo $word['pay_beingpaid'];?></h4>
            </div>
            ...
            <div class="modal-footer text-xs-center">
                <a class="btn btn-block btn-lg btn-success btn-squared m-b-20" href="<?php echo $_M['url']['callback'];?>&out_trade_no=<?php echo $data['order']['out_trade_no'];?>"><?php echo $word['pay_paidok'];?></a>
                <a class="btn btn-block btn-lg btn-danger btn-squared white" data-dismiss="modal" aria-label="Close"><?php echo $word['pay_paiderror'];?></a>
            </div>
        </div>
    </div>
</div>
<script>
var paidokurl = '<?php echo $_M['url']['callback'];?>&out_trade_no=<?php echo $data['order']['out_trade_no'];?>';
</script>
<?php
# MetInfo Enterprise Content Management System
# Copyright (C) MetInfo Co.,Ltd (http://www.metinfo.cn). All rights reserved.
