...
<div class="v52fmbx">
	...
	<table class="display dataTable ui-table new_effects" data-table-ajaxurl="{$_M['url']['own_form']}a=dojson_enterprisel_user_list"  data-table-pageLength="20">
		<thead>
			<tr>
...
-->
				...
				<th data-table-columnclass="met-center" width="150">{$_M['word']['termofvalidity']}</th>
				<th data-table-columnclass="met-center">{$_M['word']['membertips1']}</th>
				<th data-table-columnclass="met-center">{$_M['word']['lastactive']}</th>
				<th data-table-columnclass="met-center" width="150">{$_M['word']['enterprisel_name']}</th>
				<th data-table-columnclass="met-center" width="150">{$_M['word']['contacts']}</th>
		...
		<tfoot>
			<tr>
				...
				<th colspan="10" class="formsubmit">
