...
class update extends admin{
    ...
    {
        global $_M;
        $query = "UPDATE {$_M['table']['applist']} SET `ver`='{$this->appver}' WHERE `no`='{$this->appno}' ";
        DB::query($query);
    }
    ...
    public function setPlugin()
    {
        ...
        if(!DB::get_one($query)){
            $query = "INSERT INTO {$_M['table']['app_plugin']} SET no_order='0',no='{$this->no}',m_name='shop',m_action='doweb',effect=1";
            DB::query($query);
            $query = "INSERT INTO {$_M['table']['app_plugin']} SET no_order='0',no='{$this->no}',m_name='shop',m_action='doproduct_list',effect=1";
            DB::query($query);
            $query = "INSERT INTO {$_M['table']['app_plugin']} SET no_order='0',no='{$this->no}',m_name='shop',m_action='doproduct_show',effect=1";
            DB::query($query);
            $query = "INSERT INTO {$_M['table']['app_plugin']} SET no_order='0',no='{$this->no}',m_name='shop',m_action='doproduct_plugin_class',effect=1";
            DB::query($query);
            $query = "INSERT INTO {$_M['table']['app_plugin']} SET no_order='0',no='{$this->no}',m_name='shop',m_action='temporary_plugin_product_list',effect=1";
            DB::query($query);
            $query = "INSERT INTO {$_M['table']['app_plugin']} SET no_order='0',no='{$this->no}',m_name='shop',m_action='doadmin',effect=1";
            DB::query($query);
            $query = "INSERT INTO {$_M['table']['app_plugin']} SET no_order='0',no='{$this->no}',m_name='shop',m_action='doseourl',effect=1";
            DB::query($query);
            $query = "INSERT INTO {$_M['table']['app_plugin']} SET no_order='0',no='{$this->no}',m_name='shop',m_action='dopay',effect=1";
            DB::query($query);
            $query = "INSERT INTO {$_M['table']['app_plugin']} SET no_order='0',no='{$this->no}',m_name='shop',m_action='doget_goods',effect=1";
            DB::query($query);
            $query = "INSERT INTO {$_M['table']['app_plugin']} SET no_order='0',no='{$this->no}',m_name='shop',m_action='search_order',effect=1";
            DB::query($query);
            $query = "INSERT INTO {$_M['table']['app_plugin']} SET no_order='0',no='{$this->no}',m_name='shop',m_action='module_get_list_by_class_query',effect=1";
            DB::query($query);
        }
    }
