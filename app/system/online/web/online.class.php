...
class online extends web
{
    ...
    public function do_online()
    {
        ...
        if ($_M['config']['met_online_type'] != 0 ) {
            ...
            $metinfo.='<div class="onlinebox-box"><div class="onlinebox-top" '.$stit.' style="background:'.$_M['config'][met_online_color].';">';
            ...
            foreach ($online_list as $key => $val) {
                ...
                if ($val['taobao'] != ""){
                    ...
                    $metinfo .= '<p class="met_taobao list-group-item-text"><a target="_blank" href="http://www.taobao.com/webww/ww.php?ver=3&touid=' . urlencode($val['taobao']) . '&siteid=cntaobao&status=' . $_M['config']['met_taobao_type'] . '&charset=utf-8"><img src="' . $met_url . 'images/taobao/taobao.png' .'" alt=""><span>'. $val['show_name'] . '</span></a></p>';
                }
                if ($val['alibaba'] != "") {
                    if($_M['config']['met_onlinenameok']) $val['show_name']=$val['alibaba'];
                    $metinfo .= '<p class="met_alibaba list-group-item-text"><a target="_blank" href="http://amos.alicdn.com/msg.aw?v=2&uid=' . $val['alibaba'] . '&site=cnalichn&s=' . $_M['comfig']['met_alibaba_type'] . '&charset=UTF-8"><img src="' . $met_url . 'images/taobao/taobao.png' . '" alt=""><span>' . $val['show_name'] . '</span></a></p>';
                }
                if ($val['skype'] != "") {
