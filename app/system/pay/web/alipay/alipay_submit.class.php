...
class AlipaySubmit {
	...
	function buildRequestForm($para_temp, $method, $button_name) {
        ...
        //$sHtml = $sHtml."<div class='jumbotron text-center'><h1>支付宝</h1><p>数据加载跳转中....</p><p><a class='btn btn-primary btn-lg' href='#' role='button'><span class='glyphicon glyphicon-refresh'>".$button_name."</span></a></p></div>";
