                    ...
                    <div class='panel-body shop-finance'>
                        <div class="clearfix">
                            <div class="pull-xs-left">
                                <label class="control-label"><?php echo $word['pay_balance'];?> : </label>
                                <span class="tag tag-lg tag-success radius0" style="line-height:inherit;"><?php echo $data['balance']['balance_str'];?> </span>
                            </div>
                            <a href="<?php echo $_M['url']['recharge'];?>" class="btn btn-outline btn-success addr-btn btn-squared pull-xs-right"><?php echo $word['pay_recharge'];?></a>
                        </div>
                        <table class="dataTable table table-bordered table-hover table-striped w-full m-t-10" cellspacing="0" id="finance-list" data-table-ajaxurl="<?php echo $_M['url']['own_form'];?>a=dotable_list_json" data-table-pagelength='20' data-plugin="selectable">
                            <thead>
                                <tr>
                                    <th width="160"><?php echo $word['pay_time'];?></th>
                                    <th><?php echo $word['pay_price'];?></th>
                                    <th><?php echo $word['pay_balance'];?></th>
                                    <th><?php echo $word['pay_reason'];?></th>
                                </tr>
                            </thead>
                        </table>
                    </div>
