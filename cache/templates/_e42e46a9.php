...
?>
<form method="POST" action="<?php echo $_M[url][own_form];?>a=dosavepaymentconfig" target="_self" enctype="multipart/form-data">
    <div class="metadmin-fmbx">
        <dl>
            <dt><label class='form-control-label'><?php echo $word['pay_payswitch'];?></label></dt>
            <dd>
                <div class="radio-custom radio-primary radio-inline">
                    <input name="payment_open" type="radio" value="1" id='radio1' data-checked="<?php echo $data['payment_open'];?>"/>
                    <label for="radio1"><?php echo $word['open'];?></label>
                </div>
                <div class="radio-custom radio-primary radio-inline">
                    <input name="payment_open" type="radio" value="0" id='radio0'/>
                    <label for="radio0"><?php echo $word['close'];?></label>
                </div>
            </dd>
        </dl>
        <dl>
            <dt><label class='form-control-label'><?php echo $word['pay_apimanage'];?></label></dt>
            <dd>
                <div class="checkbox-custom checkbox-primary checkbox-inline">
                    <input name="payment_type" type="checkbox" id='checkbox1' value="1" data-checked="<?php echo $data['payment_type'];?>">
                    <label for='checkbox1'><?php echo $word['pay_wxscan'];?></label>
                </div>
                <div class="checkbox-custom checkbox-primary checkbox-inline">
                    <input name="payment_type" type="checkbox" id='checkbox6' value="6">
                    <label for='checkbox6'><?php echo $word['pay_wxJsApiPay'];?></label>
                </div>
                <div class="checkbox-custom checkbox-primary checkbox-inline">
                    <input name="payment_type" type="checkbox" id='checkbox7' value="7">
                    <label for='checkbox7'><?php echo $word['pay_wxh5'];?><span style="color: red">(<?php echo $word['pay_new'];?>)</span></label>
                </div>
                <div class="checkbox-custom checkbox-primary checkbox-inline">
                    <input name="payment_type" type="checkbox" id='checkbox2' value="2">
                    <label for='checkbox2'><?php echo $word['pay_alipaywappay'];?><span style="color: red">(<?php echo $word['pay_new'];?>)</span></label>
                </div>
                <div class="checkbox-custom checkbox-primary checkbox-inline">
                    <input name="payment_type" type="checkbox" id='checkbox3' value="3">
                    <label for='checkbox3'><?php echo $word['pay_alipay'];?></label>
                </div>
                <div class="checkbox-custom checkbox-primary checkbox-inline">
                    <input name="payment_type" type="checkbox" id='checkbox4' value="4">
                    <label for='checkbox4'><?php echo $word['pay_upayb2c'];?></label></div>
                <div class="checkbox-custom checkbox-primary checkbox-inline">
                    <input name="payment_type" type="checkbox" id='checkbox9' value="9">
                    <label for='checkbox9'><?php echo $word['pay_upayb2b'];?><span style="color: red">(<?php echo $word['pay_new'];?>)</span></label>
                </div>
                <div class="checkbox-custom checkbox-primary checkbox-inline">
        ...
        <dl>
            <dt><label class='form-control-label'><?php echo $word['pay_coinprefix'];?></label></dt>
            <dd class="form-group">
                <input type="text" name="pay_price_str_prefix" class="form-control w-100 m-r-10" value="<?php echo $data['pay_price_str_prefix'];?>">
            </dd>
        </dl>
        <dl>
            <dt><label class='form-control-label'><?php echo $word['pay_coinsuffix'];?></label></dt>
            <dd class="form-group">
                <input type="text" name="pay_price_str_suffix" class="form-control w-100 m-r-10" value="<?php echo $data['pay_price_str_suffix'];?>">
            </dd>
        </dl>
        <dl>
            <dt><label class='form-control-label'><?php echo $word['pay_tips1'];?></label></dt>
            <dd class="form-group">
                <textarea name="pay_charger_tips1" data-plugin='editor' data-editor-y='100' hidden><?php echo $data['pay_charger_tips1'];?></textarea>
            </dd>
        </dl>
        <dl>
            <dt></dt>
            <dd>
                <input type="submit" value="<?php echo $_M['word']['Submitall'];?>" class="btn btn-primary">
            </dd>
        </dl>
    </div>
</form>
