...
<form method="POST" action="<?php echo $_M[url][own_form];?>a=dosavealipay&type=<?php echo $data['paytype'];?>" target="_self" enctype="multipart/form-data">
    <div class="metadmin-fmbx">
        <h3 class="example-title"><?php echo $word['pay_alipay_openset_tips1'];?></h3>
            <?php if($data['set_tips_show']==1){ ?>
            <dl>
                <dd class="alert dark alert-primary radius0">
                    <?php echo $word['pay_alipay_tisps4'];?>
                        <?php if($data['phpvercheck']==1){ ?>
                        <?php echo $word['pay_alipay_openset_tips2'];?><?php echo $data['phpver'];?><?php echo $word['pay_alipay_openset_tips3'];?>
                    <?php } ?>
                        <?php if($data['openssl_sign']==1){ ?>
                        <?php echo $word['pay_alipay_openset_tips4'];?>
                    <?php } ?>
                </dd>
            </dl>
        <?php } ?>
        <dl>
            ...
            <dd class="form-group">
                <input type="text" name="app_id" value="<?php echo $data['app_id'];?>" class="form-control">
            </dd>
        </dl>
        <dl>
            <dt><label class='form-control-label'><?php echo $word['pay_alipay_private_key'];?></label></dt>
            <dd class="form-group">
                <textarea name="private_key" rows="5" placeholder='<?php echo $word['pat_alipay_private_key'];?>' class='form-control m-r-10' data-fv-callback='true' data-fv-callback-callback='custom' data-fv-callback-message=''><?php echo $data['private_key'];?></textarea>
                <span class="text-help">
                    <a href="https://openhome.alipay.com/platform/keyManage.htm" target="_blank"><?php echo $word['pay_alipay_tips6'];?></a>
                    <br>
                    <a href="https://docs.open.alipay.com/291/106097/" target="_blank"><?php echo $word['pay_alipay_tips7'];?></a>
                </span>
            </dd>
        </dl>
        <dl>
            <dt><label class='form-control-label'><?php echo $word['pay_public_key'];?></label></dt>
            <dd class="form-group">
                <textarea name="public_key" rows="5" placeholder='<?php echo $word['public_key'];?>' class='form-control m-r-10' data-fv-callback='true' data-fv-callback-callback='custom' data-fv-callback-message=""><?php echo $data['public_key'];?></textarea>
                <span class="text-help">
                    <a href="https://openhome.alipay.com/platform/keyManage.htm" target="_blank"><?php echo $word['pay_alipay_tips8'];?></a>
                </span>
            </dd>
        </dl>
        <h3 class="example-title"><?php echo $word['pay_alipay_oldapiset'];?></h3>
        <dl>
            <dt><label class='form-control-label'><?php echo $word['pay_alipay_app_partner'];?></label></dt>
            <dd class="form-group">
                <input type="text" name="app_partner" value="<?php echo $data['app_partner'];?>" class="form-control m-r-10">
                <span class="text-help"><?php echo $word['pay_alipay_tips1'];?></span>
            </dd>
        </dl>
        <dl>
            <dt><label class='form-control-label'><?php echo $word['pay_alipay_app_seller_email'];?></label></dt>
            <dd class="form-group">
                <input type="text" name="app_seller_email" value="<?php echo $data['app_seller_email'];?>" class="form-control m-r-10">
                <span class="text-help"><?php echo $word['pay_alipay_tips2'];?></span>
            </dd>
        </dl>
        <dl>
            <dt><label class='form-control-label'><?php echo $word['pay_alipay_app_key'];?></label></dt>
            <dd class="form-group">
                <input type="text" name="app_key" value="<?php echo $data['app_key'];?>" class="form-control m-r-10">
                <span class="text-help"><?php echo $word['pay_alipay_tips3'];?></span>
            </dd>
        </dl>
        <!--
        ...
        <dl>
            ...
            <dd class="ftype_upload">
                <div class="fbox">
                    <input name="app_cacert" type="text" data-upload-type="doupfile" value="<?php echo $app_cacert;?>"/>
                </div>
            </dd>
        </dl>
        -->
        <dl>
            <dt></dt>
            <dd>
                <input type="submit" value="<?php echo $_M['word']['Submit'];?>" class="btn btn-primary">
            </dd>
        </dl>
    </div>
</form>
