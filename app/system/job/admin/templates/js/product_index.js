define(function(require, exports, module) {
	...
	$('button[data-toggle="popover"]').popover({
		content:function(){
			return '<button class="btn btn-primary btn-sm list-type-del" role="button" data-value="1" style="margin-right:5px;display:none">'+METLANG.jslang0+'</button><button class="btn btn-danger btn-sm list-type-del" role="button" data-value="0" style="margin-right:5px;display:">'+METLANG.jslang1+'</button><a class="btn btn-default btn-sm listdeleteno" role="button" href="javascript:;">'+METLANG.jslang2+'</a>';
		},
		html:true,
		placement:'top'
	});
