...
class wxpay extends pay {
    ...
    public static function wxpay($date) {
        ...
        $redirect_url = $_M['url']['order_query']."out_trade_no={$date['out_trade_no']}&paytype=1&return=1";
        ...
        $input->SetTrade_type("NATIVE");            //JSAPI 公众号支付 | NATIVE 扫码支付 | APP APP支付
    ...
    public static function webH5($date) {
        global $_M;
        $notify_url = is_strinclude($_M['url']['pay_notify'], 'localhost') ? '' : $_M['url']['pay_notify'];
        $redirect_url = $_M['url']['order_query']."out_trade_no={$date['out_trade_no']}&paytype=7&return=1";
    ...
    public function JsApiPay($date,$openId) {
        ...
        $input->SetGoods_tag($date['goods_tag']);
        $input->SetNotify_url($notify_url);
        $input->SetTrade_type("JSAPI");             //JSAPI 公众号支付 | NATIVE 扫码支付 | APP APP支付
